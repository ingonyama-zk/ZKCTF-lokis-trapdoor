...
use lokidoor::{circuit::{circuit_common_preprocessed_input, circuit_witness}, G1Point, G2Point, KZG, ChallengeProofData, any_as_u8_slice, server::server_endpoint_verify};
...
fn main() {
    ...
    let response = server_endpoint_verify(&proof_bytes);
    println!("{}", response);
}